...
export function SpeechToggle() {
  ...
  return (
    <button
      ...
      className="fixed top-4 right-4 z-50 w-10 h-10 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-white hover:bg-white/30 transition-colors shadow-sm"
    >
      {muted ? (
