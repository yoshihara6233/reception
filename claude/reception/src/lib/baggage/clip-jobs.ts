 ...
 *
 * 設計: docs/baggage-inspection-system-design.html §3.1/§3.3、eng-review追補
 *   （not_before・尺80%・時計offset・全退出系でジョブ生成）。
 */
...
export interface ClipJobSettings {
  ...
  notBeforeMin?: number
  /** NU-100 の録画保持日数（deadline = 検査終了 + (これ-2)日）。 */
