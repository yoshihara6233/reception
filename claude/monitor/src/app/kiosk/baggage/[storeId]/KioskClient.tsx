...
/**
 * 顔撮影の中央クロップ倍率。2.6 は寄せ過ぎで、少し立ち位置がずれると顔が枠から
 * 見切れる（顔が全部入らない）不具合があった。1.5 に緩めて広めに撮る＝多少ずれても
 * 顔全体が入る。解像度低下は MAXDIM 引き上げで補う（照合精度を落とさない）。
 * 照合(登録/認証)は同じ倍率で撮ること＝両方これを使う。
 */
const FACE_CAPTURE_ZOOM = 1.5
/** 顔画像の長辺上限。クロップを広げたぶん顔の実ピクセルを保つため 512→720 に引き上げ。 */
