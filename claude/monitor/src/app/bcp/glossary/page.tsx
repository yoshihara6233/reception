    ...
    items: [
      {
        ...
        desc: '内閣官房・消防庁が運用する全国瞬時警報システム。地震・津波・ミサイルなどを衛星と地上回線で全国の自治体・放送局に直送し、サイレンや自動放送で住民に伝える仕組み。本システムは気象庁の防災情報XMLフィードを直接監視し、地震（震度）と気象等の特別警報を対象店舗の映像保全に結び付ける。',
      },
      {
        term: '気象庁警報',
        read: 'JMA',
        desc: '気象庁が発表する大雨・暴風等の警報。うち「特別警報」（警戒レベル5相当・大雨/土砂災害/高潮/大雪/暴風/暴風雪/波浪の各特別警報）だけを発動対象とし、区域コードの先頭2桁（JIS都道府県）で対象店舗を判定する。警報・注意報（レベル4以下）では録画しない。',
      },
      {
        term: 'エリアコード',
        read: 'area_code',
      ...
      },
      {
        term: 'アラート種別',
        read: 'alert_type',
        desc: '震度情報 (earthquake) / 特別警報 (special_warning) / テスト (test) の 3 種類。津波 (tsunami)・ミサイル (missile) は 2026-08-21 に非対応とし、過去イベントの表示にのみ残る。',
      },
    ],
  },
  {
