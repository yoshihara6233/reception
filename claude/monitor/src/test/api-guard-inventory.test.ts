...
const EXPECTED: Record<string, Guard> = {
  ...
  '/api/admin/edges/[id]/diagnostics': 'super-admin',
  '/api/admin/diagnostics/[id]/download': 'super-admin',
  '/api/admin/nvmsd-releases': 'super-admin',
  '/api/admin/nvmsd-releases/[id]': 'super-admin',
  '/api/admin/nvmsd-releases/upload-url': 'super-admin',
  ...
  '/api/admin/recorders/[id]/config': 'admin',
  ...
  '/api/edge/nvms-health': 'device-token',
  '/api/edge/nvms-sync': 'device-token',
